...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu WhatsLP da Optimus7 que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador WhatsLP da Optimus7 - Atendimento sem limites, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar WhatsLP da Optimus7\n"
  printf "   [1] Atualizar WhatsLP da Optimus7\n"
  printf "   [2] Deletar WhatsLP da Optimus7\n"
  printf "   [3] Bloquear WhatsLP da Optimus7\n"
  printf "   [4] Desbloquear WhatsLP da Optimus7\n"
  printf "   [5] Alter. dominio WhatsLP da Optimus7\n"
  printf "\n"
  read -p "> " option
